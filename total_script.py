...
##If this happens, it will prompt the user to install it, then continue.  So we repeat the
##command if the compiled file does not exist, in the hopes that now they have installed
